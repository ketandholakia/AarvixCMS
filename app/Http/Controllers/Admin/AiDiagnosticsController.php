    ...
    public function index(SettingService $settings, AiAgentRegistryService $agents)
    {
        ...
        return view('admin.ai.diagnostics', [
            ...
            'settings' => [
                ...
                'writer_model' => $settings->get('ai.models.writer.model', data_get($config, 'models.writer.model', 'fake-writer')),
                'chat_model' => $settings->get('ai.models.chat.model', data_get($config, 'models.chat.model', 'fake-chat')),
                'vision_model' => $settings->get('ai.models.vision.model', data_get($config, 'models.vision.model', 'fake-vision')),
                'image_model' => $settings->get('ai.models.image.model', data_get($config, 'models.image.model', 'fake-image')),
