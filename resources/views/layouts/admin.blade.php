    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
            ...
            <nav class="flex-1 space-y-1 overflow-y-auto overflow-x-hidden p-1 custom-scrollbar">
                ...
                <x-admin.nav-item href="#" :active="request()->routeIs('admin.posts.*')">
                    <x-slot name="icon">
                ...
                <x-admin.nav-item href="#" :active="request()->routeIs('admin.pages.*')">
                    <x-slot name="icon">
                ...
                <x-admin.nav-item href="#" :active="request()->routeIs('admin.categories.*')">
                    <x-slot name="icon">
