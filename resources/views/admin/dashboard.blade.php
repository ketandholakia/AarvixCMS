    ...
    @if($aiStats !== null)
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-7 gap-6">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Avg Queue Wait</p>
                    <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($aiStats['average_queue_wait_ms']) }} ms</p>
                </div>
            </div>
