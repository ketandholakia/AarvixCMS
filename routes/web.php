...
Route::middleware(['auth', \App\Http\Middleware\AuthorizeAdmin::class])
    ...
    ->group(function () {
        ...
        Route::get('ai/requests/export', [\App\Http\Controllers\Admin\AiRequestController::class, 'export'])->name('ai-requests.export')->middleware('admin:view_ai_usage');
        ...
        Route::get('ai-prompts/{ai_prompt}/test', [\App\Http\Controllers\Admin\AiPromptController::class, 'test'])->name('ai-prompts.test')->middleware('admin:manage_ai_prompts');
        Route::post('ai-prompts/{ai_prompt}/test', [\App\Http\Controllers\Admin\AiPromptController::class, 'testRun'])->name('ai-prompts.test.run')->middleware('admin:manage_ai_prompts');
        ...
        Route::post('ai-prompts/{ai_prompt}/duplicate', [\App\Http\Controllers\Admin\AiPromptController::class, 'duplicate'])->name('ai-prompts.duplicate')->middleware('admin:manage_ai_prompts');
        Route::get('ai/agent-runs', [\App\Http\Controllers\Admin\AiAgentRunController::class, 'index'])->name('ai-agent-runs.index')->middleware('admin:view_ai_usage');
        Route::get('ai/agent-runs/{ai_agent_run}', [\App\Http\Controllers\Admin\AiAgentRunController::class, 'show'])->name('ai-agent-runs.show')->middleware('admin:view_ai_usage');
        ...
        Route::get('ai/tool-calls/export', [\App\Http\Controllers\Admin\AiToolCallController::class, 'index'])->name('ai-tool-calls.export')->middleware('admin:view_ai_usage');
