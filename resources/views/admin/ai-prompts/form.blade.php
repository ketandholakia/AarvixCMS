    ...
    <form action="{{ $prompt->exists ? route('admin.ai-prompts.update', $prompt) : route('admin.ai-prompts.store') }}" method="POST" class="space-y-0">
        ...
        <div class="p-6 grid gap-6 lg:grid-cols-2">
            ...
            <div class="lg:col-span-2">
                <x-admin.form.textarea name="system_template" label="System Template" :value="$version['system_template'] ?? ''" required="true" rows="8" help="Supports strict `{{variable}}` placeholders." />
            </div>
            <div class="lg:col-span-2">
